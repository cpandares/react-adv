...
import { FormikBasicPage, FormikYupPage, FormikComponents, FormikAbstraction, RegisterFormikPage, DynamicFormPage} from "../03-forms/pages";
    ...
    <BrowserRouter>
      <div className="main-layout">
        ...
        <Routes>
            ...
            <Route path="dinamic-form" element={ <DynamicFormPage /> }/>
